...
window.siteConfig = {
    ...
    "logoMobileFontSize": "1.25rem", // NEW (Optional): Font size for the text logo in the mobile header. If not specified, it will be calculated from logoFontSize.
    ...
    "accentColor": "#9a482d", // Main accent color for the light theme (used for links, buttons, active elements). Use a HEX color code (e.g., #FF5733 for orange, #007bff for blue).
    "darkAccentColor": "#d99175", // OPTIONAL: Accent color for the dark theme. If not specified, it will be automatically calculated from 'accentColor'.
